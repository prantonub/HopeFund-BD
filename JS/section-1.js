document.addEventListener("DOMContentLoaded", () => {
  ...
  const historyContent = document.getElementById("historyContent-1");
  const viewHistoryBtn = document.getElementById("view-history-btn-1");
  ...
  donateBtn?.addEventListener("click", () => {
    ...
    entry.setAttribute("data-region", "noakhali");
    entry.innerHTML = `
      <h3 class="text-lg font-semibold text-lime-600">${amount} BDT Donated</h3>
      <p class="text-base mt-2 text-gray-800">
        For Flood at <span class="font-medium text-lime-500">Noakhali, Bangladesh</span>
      </p>
  ...
  viewHistoryBtn.addEventListener("click", () => {
    ...
    const section1Entries = document.querySelectorAll("#historyContent-1 > div");

    section1Entries.forEach(e => {
